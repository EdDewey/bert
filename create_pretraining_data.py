    ...
    flags = attrdict.Attrdict(
        {
            ...
            'vocab_file': '/home/ubuntu/bert/wwm_uncased_L-24_H-1024_A-16/vocab.txt',
            'do_lower_case': True,
...
def write_instance_to_example_files(instances, tokenizer, max_seq_length,
    ...
    for (inst_index, instance) in enumerate(instances):
        input_ids = tokenizer.convert_tokens_to_ids(instance.tokens)  # Ed: we need to do this.  Next line too
